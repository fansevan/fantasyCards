    ...
    <main>
      <div id="content_wrapper">
        ...
        <?php      
          ...
          for ($i=0; $i < count($files); $i++) { 
            ...
            if ($currentFile != '.' && $currentFile != '..') {            
              echo "<div class='imgdiv'><img class='imgportfolio' src='" . $directory . 
                    $currentFile . "' alt='image-" . $nameWithoutExt . "'/><p>" .
                    $currentFile . "<button onclick='deleteImage(\"portfolio\", \"" . $nameWithoutExt . "\",\"" . 
        ...
        <form action="upload.php" method="post" enctype="multipart/form-data">
          ...
          <input type='hidden' name='directory' value='portfolio'/>
