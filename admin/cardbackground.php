...
<head>
  ...
  <title>Админ-панель: Фон открытки</title>     
  ...
  <div id="page_wrapper">
    <main>
      <div id="content_wrapper">
        ...
        <?php      
          $directory = "../img/cards/background/";
          ...
          for ($i=0; $i < count($files); $i++) { 
            ...
            if ($currentFile != '.' && $currentFile != '..') {            
              echo "<div class='imgdiv'><img class='imgbackground' src='" . $directory . 
                    $currentFile . "' alt='image-" . $nameWithoutExt . "'/><p>" .
                    $currentFile . "<button onclick='deleteImage(\"background\", \"" . $nameWithoutExt . "\",\"" . 
        ...
        <form action="upload.php" method="post" enctype="multipart/form-data">
          ...
          <input type='hidden' name='directory' value='background'/>
